...
async function openModal(habitId) {
  ...
  modalContent.innerHTML =
    ...
    '<div class="flex gap-3">' +
      ...
      '<button class="delete-habit-btn flex-1 py-2.5 rounded-xl text-sm font-medium transition-all border-2 text-gray-500 border-gray-200 hover:border-gray-300 hover:text-gray-700" style="background:#fff" data-id="' + habitId + '">حذف</button>' +
    '</div>';
